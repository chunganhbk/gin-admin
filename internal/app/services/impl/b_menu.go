...
var _ services.IMenu = (*Menu)(nil)

// MenuSet 注入Menu
var MenuSet = wire.NewSet(wire.Struct(new(Menu), "*"), wire.Bind(new(services.IMenu), new(*Menu)))

// Menu 菜单管理
type Menu struct {
	TransModel              models.ITrans
	MenuModel               models.IMenu
	MenuActionModel         models.IMenuAction
	MenuActionResourceModel models.IMenuActionResource
}

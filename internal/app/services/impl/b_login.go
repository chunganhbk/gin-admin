...
var _ services.ILogin = (*Login)(nil)

// LoginSet 注入Login
var LoginSet = wire.NewSet(wire.Struct(new(Login), "*"), wire.Bind(new(services.ILogin), new(*Login)))

// Login 登录管理
type Login struct {
	Auth            auth.Auther
	UserModel       models.IUser
	UserRoleModel   models.IUserRole
	RoleModel       models.IRole
	RoleMenuModel   models.IRoleMenu
	MenuModel       models.IMenu
	MenuActionModel models.IMenuAction
}
